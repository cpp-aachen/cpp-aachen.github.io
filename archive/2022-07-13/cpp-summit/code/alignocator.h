/**
 From https://github.com/olawlor/osl/blob/master/alignocator.h
...
class alignocator
{
  public:
    ...
    bool operator!=(const alignocator& other) const { return !(*this == other); }
    ...
    bool operator==(const alignocator& other) const { return true; }
    ...
    template<typename U>
    alignocator(const alignocator<U, alignment>&)
    {}
    ...
    T* allocate(const size_t n) const
    {
        ...
        if (n > max_size()) { throw std::length_error("alignocator<T>::allocate() - Integer overflow."); }
